// importing game stats functions
...
//          |__scene1.js
//          |__scene2.js
import * as chapter1 from "./chapters/chapter1/index.js";
...
function renderText(subScene) {
    ...
    if (subScene.hasOwnProperty("getTextInputFor")) {
...
function renderChoices(subScene) {
    ...
    subScene.choices.forEach((choice) => {
        ...
        if (choice.hidden === true) { /* do nothing */ }
            ...
            choiceButton.classList.add("button", "story-choice");
            choiceButton.innerText = choice.text;
            storyChoicesDiv.appendChild(choiceButton);
            choiceButton.addEventListener("click", () => {
                if (subScene.hasOwnProperty("getTextInputFor")) {
                    const textInput = document.getElementById("text-input");
                    stats.set(subScene.getTextInputFor, textInput.value);
                }
                choice.run();
